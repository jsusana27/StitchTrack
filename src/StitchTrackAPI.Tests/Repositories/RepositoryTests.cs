...
namespace CrochetBusinessAPI.Tests.Repositories
{
    public class RepositoryTests
    {
        ...
        public async Task GetAllAsync_ShouldReturnAllEntities()
        {
            ...
            //Act
            var yarns = await repository.GetAllAsync();
        ...
        public async Task GetByIdAsync_ShouldReturnEntityIfExists()
        {
            ...
            {
                //Act
                var retrievedYarn = await repository.GetByIdAsync(yarn.YarnID.Value);
                //Assert
        ...
        public async Task GetByIdAsync_ShouldReturnNullIfEntityDoesNotExist()
        {
            ...
            //Act
            var retrievedYarn = await repository.GetByIdAsync(-1); //Use an invalid ID
        ...
        public async Task InsertAsync_ShouldAddEntityToDatabase()
        {
            ...
            //Act
            var insertedYarn = await repository.InsertAsync(newYarn);
        ...
        public async Task UpdateAsync_ShouldUpdateExistingEntity()
        {
            ...
            //Act
            var updatedYarn = await repository.UpdateAsync(existingYarn);
        ...
        public async Task UpdateAsync_ShouldReturnNullIfEntityDoesNotExist()
        {
            ...
            //Act
            var result = await repository.UpdateAsync(nonExistentYarn);
        ...
        public async Task SaveAsync_ShouldSaveChangesToDatabase()
        {
            ...
            var newYarn = new Yarn
            {
                ...
                Color = "White",
                Price = 10.0m,
                NumberOfSkeinsOwned = 40,
                YardagePerSkein = 300,
                GramsPerSkein = 150
            };

            //Act
            await repository.InsertAsync(newYarn); //Add new yarn to the context
            await repository.SaveAsync(); //Save changes explicitly
